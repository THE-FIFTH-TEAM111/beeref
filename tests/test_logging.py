...
@patch('beeref.logger.BeeLogger.log')
...
def test_rotating_file_handler_uses_existing_dir(tmpdir):
...
@patch('beeref.logger.qtlogger.info')
...
@patch('beeref.logger.qtlogger.warning')
